...
def display_affordability_results(buyer: BuyerProfile, market: MarketConditions, result: AffordabilityResult) -> None:
    ...
    print('-----------------------------------------')
    print(f'Annual Income:         ${buyer.annual_income:,.2f}')
    print(f'Down Payment:          ${buyer.down_payment:,.2f}')
    print(f'Student Loans:         ${buyer.monthly_student_loans:,.2f}')
    print(f'Other Debt:            ${buyer.monthly_other_debts:,.2f}')
    print('\nMarket Conditions\n')
    print('-----------------------------------------')
    print(f'Interest Rate:          {market.interest_rate*100:.2f}%')
    print(f'Property Tax:            {market.property_tax_rate*100}%')
    ...
    print('=========================================')
    print(f'\nMaximum Affordable Price: ${result.max_affordable_price:,.2f}')
    print(f'Maximum Monthly PITI:       ${result.max_monthly_piti:,.2f}')
    print('\nMonthly Housing Costs')
    print('-----------------------------------------')
    print(f'Principal & Interest:       ${result.monthly_principal_interest:,.2f}')
    print(f'Property Tax:               ${result.monthly_property_tax:,.2f}')
    print(f'Insurance:                  ${result.monthly_insurance:,.2f}')
    print(f'PMI:                        ${result.monthly_pmi:,.2f}')
    print('\nDTI Analysis')
    print('-----------------------------------------')
    print(f'Front-End DTI:              {result.actual_front_end_dti * 100:.2f}%')
    print(f'Back-End DTI:               {result.actual_back_end_dti * 100:.2f}%')
    print('\nLimiting Factor:')
    print(f'-> {result.limiting_factor}')
    print('\n=========================================')
